        ...
        <>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-surface-400 mt-2">{notes.length} notes available</p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-surface-900/30 rounded-2xl border border-surface-800/50">
                        ...
                        <h3 className="text-lg font-semibold text-surface-400">No notes found for this subject</h3>
                        <p className="text-surface-500 text-sm mt-1">Be the first to upload!</p>
                    </div>
                ) : (
