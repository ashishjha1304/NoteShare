            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                <div className="text-center mb-8">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-primary-500/25">
                        <HiOutlineCloudUpload className="w-7 h-7 text-white" />
                    </div>
                    <h1 className="text-3xl font-display font-bold text-white">Upload Notes</h1>
                    <p className="text-surface-400 mt-2">Share your study materials with the community</p>
                </div>
